...
RUN wget https://download.elastic.co/elasticsearch/elasticsearch/elasticsearch-1.7.5.deb
...
#	&& apt-get install -y --no-install-recommends elasticsearch-1.7.5.deb \
